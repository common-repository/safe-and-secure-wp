...
$api_url     = 'https://beholder.azure-api.net/authentication-list/v1/authentication-recent/' . $site_domain;
$json        = wp_remote_get(
	$api_url,
	array(
		'headers' => array(
...
<table id="innerExample" class="table table-sm table-hover">
	<thead class="thead-dark">
		<tr>
			<th colspan="6">Latest Results</th>
		</tr>
		<tr>
...
<a href="admin.php?page=saswp-logview">View all Log results</a>
...
<script>
	jQuery(document).ready(function() {
		...
		var data = json.slice(0, 5); // cut the list to just the l
